...
Eleven Music으로 생성한 음원의 상업적 이용 가능 여부는 계정 플랜의 라이선스 조항에 달려 있다.
2026-08-17에 저장소 소유자가 사용 중인 유료 플랜에서 상업적 이용이 가능함을 확인했다.
따라서 생성된 BGM을 YouTube 수익화 영상에 사용할 수 있다.

플랜을 변경하거나 다운그레이드할 때는 이 조건을 다시 확인한다.
